...
<?php
if(isset($_REQUEST['btnAddProduct']) == true)
{
...
<?php
if(isset($_REQUEST['btnViewProduct']) == true)
{
...
?>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="PMS_home.php">
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						...
						<button class="contact100-form-btn" name="btnAddProduct" id="btnAddProduct">
							<span>
								ADD NEW PRODUCT
							</span>
						</button>
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						<div class="contact100-form-bgbtn"></div>
						<button class="contact100-form-btn" name="btnViewProduct" id="btnViewProduct">
							<span>
								VIEW PRODUCTS
							</span>
						</button>
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						<div class="contact100-form-bgbtn"></div>
						<button class="contact100-form-btn" name="logout" id="logout">
							<span>
								Logout
							</span>
						</button>
