...
$(document).ready(function (){
	...
	$("#btnLogin").click(function() {
		...
		if($u == "")
		{
			alert("Login Username is mandatory !");
			flag = false;
		}
		if($p == "")
		{
			alert("Login password is mandatory !");
			flag = false;
		}
...
<?php
 ...
 if(isset($_REQUEST['btnLogin']) == true )
 {
	...
	$upsd = $_REQUEST['pass'];
	$sql = "SELECT * from admin where Login='$uname' and Password='$upsd'";
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="PMS_signUp.php">
					...
					<div class="text-center p-t-115">
						...
						<a class="txt2" href="PMS_signIn.php">
							Sign Up
						</a>
					</div>
					<?php 
                      if($error != "")
                      {
	                    echo "<span class='text-center p-t-115 txt1' style='color:red;padding-left:17%;'>$error</span>";
                      }
                    ?>
				</form>
			</div>
